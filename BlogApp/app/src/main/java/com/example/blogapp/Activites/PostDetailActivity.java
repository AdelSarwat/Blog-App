...
import com.example.blogapp.modles.Comment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       postImage2=postImage;
        imgPost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DispayImageActivity.imagediaplay=postImage2;
                DispayImageActivity.UserName=firebaseUser.getDisplayName();
                Intent intent = new Intent(getApplicationContext(),DispayImageActivity.class);
